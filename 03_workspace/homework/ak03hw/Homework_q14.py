...
def epoch_to_datetime(epoch_millis):
...
if __name__ == '__main__':
    ...
    # 用來記錄最大與最小的"pickup_datetime" <---- 存放 "題目#14" 答案的容器
    min_pickup_datetime = None
    min_row_number = ''
    max_pickup_datetime = None
    max_row_number = ''
        ...
        while True:
            ...
            for record in records:
                ...
                if record.error():
                    ...
                    # Tips: 比較pickup_date與min_pickup_datetime
                    #       把最早與最晚的值保留下來
            ...
            # 打印出最更新的結果 <---- "題目#14" 的答案
            # 由於pickup_datetime是epoch millis, 所以我們要轉行轉換

            print('Total received records: ' + str(record_counter))
            print('pickup_datetime-Min: ' + epoch_to_datetime(min_pickup_datetime))
            print('pickup_datetime-Max: ' + epoch_to_datetime(max_pickup_datetime))
