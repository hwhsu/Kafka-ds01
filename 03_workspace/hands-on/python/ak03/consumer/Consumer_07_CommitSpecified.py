...
# 當發生Re-balance時, 如果有partiton被assign時被呼叫
...
# 當Rebalance被觸發後, Commit現在process的offets
...
if __name__ == '__main__':
    ...
    try:
        while True:
            recrods_pulled = False # 用來檢查是否有有效的record被取出來
            # 請求Kafka把新的訊息吐出來
            ...
            for record in records:
                ...
                if record.error():
                    ...
                    offsets_dict[offset_key] = record # 保留同一個topic/partiton最後的record
